                                ...
                                <div class="block-content collapse in">
                                    <div id="page-wrapper">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <?php
                                            $new = mysqli_query($conn, "SELECT * FROM  members WHERE  DATE_SUB(STR_TO_DATE(date, '%Y-%m-%d'), INTERVAL YEAR(CURDATE())-YEAR(STR_TO_DATE(date, '%Y-%m-%d')) YEAR) 
...
WHERE  DATE_ADD(STR_TO_DATE(Birthday, '%Y-%m-%d'), INTERVAL YEAR(CURDATE())-YEAR(STR_TO_DATE(Birthday, '%Y-%m-%d')) YEAR) 
            BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 7 DAY)");
                                    ...
                                    <div id="page-wrapper">
                                        <?php
                                        $result2 = mysqli_query($conn, 'SELECT SUM(Amount) AS value_sum FROM giving WHERE stat = "Yes"');
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <?php
                                            $result = mysqli_query($conn, 'SELECT SUM(Amount) AS value_sum FROM offering WHERE stat = "Yes"');
