				...
				<div class="row-fluid">
					<div class="empty">
						<div class="alert alert-success alert-dismissable">
							...
							<i class="icon-info-sign"></i> <strong>Note!:</strong> Select the checbox if you want to update if received?
						</div>
					</div>
							...
							<div class="span12">
								<form action="update_payments.php" method="post">
									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										<a data-placement="right" title="Click to Update checked item" data-toggle="modal" href="#update_offering" id="delete" class="btn btn-success" name=""><i class="icon-trash icon-large"> Update</i></a>
										<script type="text/javascript">
											$(document).ready(function() {
												$('#delete').tooltip('show');
												$('#delete').tooltip('hide');
										...
										<tbody>
											...
											?>
												...
												<tr>
													<td width="70">
														<input id="optionsCheckbox" class="uniform_on" name="selector[]" type="checkbox" value="<?php echo $row['offeringid']; ?>">
													</td>
