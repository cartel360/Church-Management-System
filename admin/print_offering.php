...
font-family:"Times New Roman","serif"'>Powered by Don Bosco Makuyu Parish System <?php
                                                                                  $date = new DateTime();
                                                                                  echo $date->format('Y');
                                                                                  ?></span></b></p>
...
"Times New Roman","serif"'>
 ...
 mso-yfti-tbllook:1184;mso-padding-alt:0in 5.4pt 0in 5.4pt'>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date<o:p></o:p></span></b></p>
                        ...
                        <!-- mysqli FETCH ARRAY-->
                        <?php
                        $student_query = mysqli_query($conn, "select * from members INNER JOIN offering ON members.mobile=offering.na WHERE offering.stat = 'Yes' ") or die(mysqli_error());
